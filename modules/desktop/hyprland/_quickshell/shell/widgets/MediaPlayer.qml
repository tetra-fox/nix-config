...
BarPopupButton {
    ...
    MprisSelector {
        id: sel
        pollPosition: root.isPlaying && root.popupVisible
    ...
    FloatingNotes {
        // escape the default alias: this floats over the bar icon, not in the popup
        parent: root
        anchors.centerIn: parent
        width: 70
        height: 50
        active: root.isPlaying && !root.popupVisible
    }
